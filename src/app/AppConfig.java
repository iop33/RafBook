...
public class AppConfig {
	...
	public static MutexState mutexState;
	...
	public static void readConfig(String configName, int serventId){
		...
		try{
			directory= properties.getProperty("working_dir");
		}catch (Exception e){
			timestampedErrorPrint("Problem reading working_dir. Exiting...");
			System.exit(0);
		}
		...
		AppConfig.chordState.addFriend(serventPort); // Add myself as friend
